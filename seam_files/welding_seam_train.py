...
def obj2txt(folder_data):
    ...
    for obj_file_path in glob.glob(f"{folder_data}/*.obj"):
        ...
        with open(f"./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/02773838/{os.path.basename(obj_file_path).split('.')[0]}.txt", 'w') as file:
            for row in sampled_result:
                file.write(' '.join(map(str, row)) + '\n')

def update_train_test_json():
    workpiece_list = glob.glob("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/02773838/*.txt")
    workpiece_list = [ f"shape_data/02773838/{os.path.basename(x).replace('.txt','')}" for x in workpiece_list]

    with open("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/train_test_split/shuffled_test_file_list.json") as f:
    ...
    with open("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/train_test_split/shuffled_test_file_list.json","w") as fout:
        json.dump(shuffled_test_file_list,fout)

    with open("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/train_test_split/shuffled_train_file_list.json") as f:
    ...
    with open("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/train_test_split/shuffled_train_file_list.json","w") as fout:
        json.dump(shuffled_train_file_list,fout)


    with open("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/train_test_split/shuffled_val_file_list.json") as f:
    ...
    with open("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/train_test_split/shuffled_val_file_list.json","w") as fout:
        json.dump(shuffled_val_file_list,fout)

    os.remove("./data/ShapeNetPart/shapenetcore_partanno_segmentation_benchmark_v0_normal/processed/test_2048_fps.pkl")
